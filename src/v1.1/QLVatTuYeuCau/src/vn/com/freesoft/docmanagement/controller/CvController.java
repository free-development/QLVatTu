...
import vn.com.freesoft.docmanagement.dao.FileDAO;
...
import vn.com.freesoft.docmanagement.dao.ReadExcelCongVan;
...
import vn.com.freesoft.docmanagement.entity.File;
...
public class CvController extends HttpServlet {
	...
	public void downloadFileMn(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			vn.com.freesoft.docmanagement.entity.File f = fileDAO.getByCongVanId(cvId);
			fileDAO.close();

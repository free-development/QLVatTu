...
public class VtController extends HttpServlet {
	...
	public ModelAndView manageVt(HttpServletRequest request, HttpServletResponse response)
	...
	@RequestMapping(value = "/preEditvt", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE)
	...
	@RequestMapping(value = "/addvt", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE)
	public @ResponseBody String addvt(@RequestParam("vtMa") String vtMa, @RequestParam("vtTen") String vtTen,
	...
	@RequestMapping(value = "/updatevt", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE)
	public @ResponseBody String updatevt(@RequestParam("vtMaUpdate") String vtMaUpdate,
			@RequestParam("vtTenUpdate") String vtTenUpdate, HttpServletRequest request) {
		HttpSession session = request.getSession(false);
		VaiTroDAO vtDAO = new VaiTroDAO();
	...
	@RequestMapping(value = "/deletevt", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE)
	...
	@RequestMapping(value = "/loadPagevt", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE)

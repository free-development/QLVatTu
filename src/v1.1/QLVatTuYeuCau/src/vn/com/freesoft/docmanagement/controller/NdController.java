...
import vn.com.freesoft.docmanagement.dao.CTNguoiDungDAO;
import vn.com.freesoft.docmanagement.dao.ChucDanhDAO;
import vn.com.freesoft.docmanagement.dao.NguoiDungDAO;
import vn.com.freesoft.docmanagement.entity.CTNguoiDung;
import vn.com.freesoft.docmanagement.entity.ChucDanh;
...
import vn.com.freesoft.docmanagement.util.Mail;
import vn.com.freesoft.docmanagement.util.SendMail;
import vn.com.freesoft.docmanagement.util.StringUtil;
...
public class NdController extends HttpServlet {
	...
	public ModelAndView ndManage(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (authentication == null) {
				logger.error("Không chứng thực truy cập quản lý ngư�?i dùng");
				return new ModelAndView(siteMap.login);
			} else if (!authentication.getChucDanh().getCdMa().equals(adminMa)) {
				logger.error("Không có quy�?n truy cập quản lý ngư�?i dùng");
				return new ModelAndView(siteMap.login);
			}
			...
			if ("AddNd".equalsIgnoreCase(action)) {
				...
				ArrayList<NguoiDung> nguoiDungList = (ArrayList<NguoiDung>) nguoiDungDAO
						.getAllNguoiDung(new ArrayList<String>());
			...
			logger.error("Lỗi khi truy cập ngư�?i dùng: " + e.getMessage());
			return new ModelAndView(siteMap.login);
		}
	}

	@RequestMapping(value = "/addNd", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE)
	public @ResponseBody String addNd(@RequestParam("msnv") String msnv, @RequestParam("chucdanh") String chucdanh,
			@RequestParam("matkhau") String matkhau, @RequestParam("hoten") String hoten,
			@RequestParam("sdt") String sdt, @RequestParam("email") String email, @RequestParam("diachi") String diachi,
		...
		try {
			...
			String adminMa = context.getInitParameter("adminMa");
			if (authentication == null) {
				logger.error("Không chứng thực khi thêm ngư�?i dùng");
				return JSonUtil.toJson("authentication error");
			} else if (!authentication.getChucDanh().getCdMa().equals(adminMa)) {
				logger.error("Không có quy�?n thêm ngư�?i dùng");
				return JSonUtil.toJson("authentication error");
			}
			NguoiDungDAO nguoiDungDAO = new NguoiDungDAO();
			CTNguoiDungDAO ctNguoiDungDAO = new CTNguoiDungDAO();
			...
			logger.error("Lỗi khi thêm ngư�?i dùng: " + e.getMessage());
			return JSonUtil.toJson("authentication error");
		}

	}

	@RequestMapping(value = "/preUpdateNd", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE)
	public @ResponseBody String preUpdateNd(@RequestParam("msnv") String msnv, HttpServletRequest request) {
		try {
			...
			String adminMa = context.getInitParameter("adminMa");
			if (authentication == null) {
				logger.error("Không chứng thực khi show cập nhật ngư�?i dùng");
				return JSonUtil.toJson("authentication error");
			} else if (!authentication.getChucDanh().getCdMa().equals(adminMa)) {
				logger.error("Không có quy�?n show cập nhật ngư�?i dùng");
				return JSonUtil.toJson("authentication error");
			}
			NguoiDungDAO nguoiDungDAO = new NguoiDungDAO();
	...
	@RequestMapping(value = "/updateNd", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE)
	public @ResponseBody String updateNd(@RequestParam("msnv") String msnv, @RequestParam("hoten") String hoten,
			@RequestParam("chucdanh") String chucdanh, @RequestParam("email") String email,
			@RequestParam("diachi") String diachi, @RequestParam("sdt") String sdt, HttpServletRequest request) {
		try {
			HttpSession session = request.getSession(false);
			NguoiDung authentication = (NguoiDung) session.getAttribute("nguoiDung");
			String adminMa = context.getInitParameter("adminMa");
			if (authentication == null) {
				logger.error("Không chứng thực cập nhật ngư�?i dùng");
				return JSonUtil.toJson("authentication error");
			} else if (!authentication.getChucDanh().getCdMa().equals(adminMa)) {
				logger.error("Không có quy�?n cập nhật ngư�?i dùng");
				return JSonUtil.toJson("authentication error");
			}
			...
			logger.error("Lỗi khi cập nhật ngư�?i dùng: " + e.getMessage());
			return JSonUtil.toJson("authentication error");
		}
	}

	@RequestMapping(value = "/changePass", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE)
	public @ResponseBody String changePass(@RequestParam("msnv") String msnv, @RequestParam("passOld") String passOld,
		...
		try {
			...
			logger.error("Lỗi khi đổi mật khẩu ngư�?i dùng: " + e.getMessage());
			return JSonUtil.toJson("authentication error");
		}
	}
	...
	@RequestMapping(value = "/lockNd", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE)
	public @ResponseBody String lockNd(@RequestParam("ndList") String ndList, HttpServletRequest request) {
		try {
			...
			String adminMa = context.getInitParameter("adminMa");
			if (authentication == null) {
				logger.error("Không chứng thực khóa ngư�?i dùng");
				return JSonUtil.toJson("authentication error");
			} else if (!authentication.getChucDanh().getCdMa().equals(adminMa)) {
				logger.error("Không có quy�?n khóa ngư�?i dùng");
				return JSonUtil.toJson("authentication error");
			}
			...
			logger.error("Lỗi khi khóa ngư�?i dùng: " + e.getMessage());
			return JSonUtil.toJson("authentication error");
		}
	}

	@RequestMapping(value = "/resetNd", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE)
	public @ResponseBody String resetNd(@RequestParam("ndList") String ndList, HttpServletRequest request) {
		try {
			...
			String adminMa = context.getInitParameter("adminMa");
			if (authentication == null) {
				logger.error("Không chứng thực reset ngư�?i dùng");
				return JSonUtil.toJson("authentication error");
			} else if (!authentication.getChucDanh().getCdMa().equals(adminMa)) {
				logger.error("Không có quy�?n reset ngư�?i dùng");
				return JSonUtil.toJson("authentication error");
			}
			String[] str = ndList.split("\\, ");
			NguoiDungDAO nguoiDungDAO = new NguoiDungDAO();
			...
			logger.error("Lỗi khi reset ngư�?i dùng: " + e.getMessage());
			return JSonUtil.toJson("authentication error");
		}
	}

	@RequestMapping(value = "/resetMK", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE)
	public @ResponseBody String resetMK(@RequestParam("ndList") String ndList, HttpServletRequest request) {
		try {
			...
			String adminMa = context.getInitParameter("adminMa");
			if (authentication == null) {
				logger.error("Không chứng thực reset mật khẩu ngư�?i dùng");
				return JSonUtil.toJson("authentication error");
			} else if (!authentication.getChucDanh().getCdMa().equals(adminMa)) {
				logger.error("Không có quy�?n reset mật khẩu ngư�?i dùng");
				return JSonUtil.toJson("authentication error");
			}
			String[] str = ndList.split("\\, ");
			CTNguoiDungDAO ctnguoiDungDAO = new CTNguoiDungDAO();
			...
			logger.error("Lỗi khi reset mật khẩu ngư�?i dùng: " + e.getMessage());
			return JSonUtil.toJson("authentication error");
		}
	}
	...
	public ModelAndView lockNguoiDung(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		try {
			HttpSession session = request.getSession(false);
			NguoiDung authentication = (NguoiDung) session.getAttribute("nguoiDung");
			...
			request.setAttribute("size", size);
			// ArrayList<NguoiDung> nguoiDungList = (ArrayList<NguoiDung>)
			// nguoiDungDAO.getAllNguoiDung(ignoreList);
	...
	public ModelAndView resetNguoiDung(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		try {
			HttpSession session = request.getSession(false);
			NguoiDung authentication = (NguoiDung) session.getAttribute("nguoiDung");
	...
	public ModelAndView updateNguoiDung(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		try {
			HttpSession session = request.getSession(false);
			NguoiDung authentication = (NguoiDung) session.getAttribute("nguoiDung");
			String adminMa = context.getInitParameter("adminMa");
			if (authentication == null) {
				logger.error("Không chứng thực truy cập cập nhật ngư�?i dùng");
				return new ModelAndView(siteMap.login);
			} else if (!authentication.getChucDanh().getCdMa().equals(adminMa)) {
				logger.error("Không có quy�?n truy cập nhật ngư�?i dùng");
				return new ModelAndView(siteMap.login);
			}
			String truongPhongMa = context.getInitParameter("truongPhongMa");
			CTNguoiDungDAO nguoiDungDAO = new CTNguoiDungDAO();
			...
			logger.error("Lỗi khi truy cập nhật ngư�?i dùng: " + e.getMessage());
			return new ModelAndView(siteMap.login);
		}
	}

	@RequestMapping(value = "/loadHoten", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE)
	public @ResponseBody String loadHoten(@RequestParam("msnv") String msnv, HttpServletRequest request) {
		try {
			...
			logger.error("Lỗi khi truy cập quản lý ngư�?i dùng: " + e.getMessage());
			return JSonUtil.toJson("authentication error");
		}
	}
	...
	// public @ResponseBody String loadPageNd(@RequestParam("pageNumber") String
	// pageNumber) {
	// System.out.println("MA: " + pageNumber);
	// CTNguoiDungDAO nguoiDungDAO = new CTNguoiDungDAO();
	// int page = Integer.parseInt(pageNumber);
	// ArrayList<NguoiDung> ndList = (ArrayList<NguoiDung>)
	// nguoiDungDAO.limit((page -1 ) * 10, 10);
	// nguoiDungDAO.disconnect();
	// return JSonUtil.toJson(ndList);
	// }
	@RequestMapping(value = "/loadPageNd", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE)
	public @ResponseBody String loadPageNd(@RequestParam("pageNumber") String pageNumber, HttpServletRequest request) {
		try {
			...
			String adminMa = context.getInitParameter("adminMa");
			if (authentication == null) {
				logger.error("Không chứng thực phân trang ngư�?i dùng");
				return JSonUtil.toJson("authentication error");
			}
			String truongPhongMa = context.getInitParameter("truongPhongMa");
			int page = Integer.parseInt(pageNumber);
			...
			logger.error("Lỗi khi phân trang ngư�?i dùng: " + e.getMessage());
			return JSonUtil.toJson("authentication error");
		}
	}

	@RequestMapping(value = "/loadPageNdKP", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE)
	...
	@RequestMapping(value = "/timKiemNguoidung", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE)
	public @ResponseBody String timKiemNguoidung(@RequestParam("msnv") String msnv, @RequestParam("hoTen") String hoTen,
		...
		try {
			...
			NguoiDung authentication = (NguoiDung) session.getAttribute("nguoiDung");
			if (authentication == null) {
				logger.error("Không chứng thực tìm kiếm ngư�?i dùng");
				return JSonUtil.toJson("authentication error");
			}
			NguoiDungDAO nguoiDungDAO = new NguoiDungDAO();
			...
			logger.error("Lỗi khi tìm kiếm ngư�?i dùng: " + e.getMessage());
			return JSonUtil.toJson("authentication error");
		}
	}

	@RequestMapping(value = "/timNguoiDungKhoa", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE)
	public @ResponseBody String timNguoiDungKhoa(@RequestParam("msnv") String msnv, @RequestParam("hoTen") String hoTen,
			HttpServletRequest request) {
		try {
			HttpSession session = request.getSession(false);
			NguoiDung authentication = (NguoiDung) session.getAttribute("nguoiDung");

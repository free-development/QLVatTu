...
public class DvtController extends HttpServlet {
	...
	public ModelAndView manageDvt(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (authentication == null) {
				...
				logger.error("Không có quy�?n truy cập danh mục đơn vị tính");
				return new ModelAndView(siteMap.login);
			}
	...
	@RequestMapping(value = "/preEditdvt", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE)
	...
	@RequestMapping(value = "/updatedvt", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE)
	...
	@RequestMapping(value = "/deletedvt", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE)
	...
	@RequestMapping(value = "/loadPagedvt", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE)
